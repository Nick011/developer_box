...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'developer_box_profile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))

        # Changing field 'Item.slug'
        db.alter_column(u'developer_box_item', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.user'
        db.alter_column(u'developer_box_profile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(default='', to=orm['auth.User'], unique=True))

        # Changing field 'Item.slug'
        db.alter_column(u'developer_box_item', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50))
    ...
    models = {
        ...
        'developer_box.follower': {
            'Meta': {'object_name': 'Follower'},
            'following': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'followee'", 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'follower'", 'to': u"orm['auth.User']"})
        },
        'developer_box.item': {
