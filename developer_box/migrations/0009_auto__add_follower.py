...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'developer_box_follower', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='follower', to=orm['auth.User'])),
            ('following', self.gf('django.db.models.fields.related.ForeignKey')(related_name='followee', to=orm['auth.User'])),
        ))
        db.send_create_signal('developer_box', ['Follower'])


    def backwards(self, orm):
        # Deleting model 'Follower'
        db.delete_table(u'developer_box_follower')
